...
$query =mysqli_query( $con,"SELECT NIP_pengaju,jenis_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,no_tlp,sp_kabid,sp_alasan FROM cuti_sakit  WHERE  id_pengajuan='$id_pengajuan'  ");
