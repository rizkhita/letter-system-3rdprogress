...
$query =mysqli_query( $con,"SELECT NIP_pengaju,jenis_cuti,alasan_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,no_tlp,sp_dinas,sp_alasan1,sp_bkd,sp_alasan2 FROM cuti_ltn  WHERE  id_pengajuan='$id_pengajuan'  ");
