...
$query =mysqli_query( $con,"SELECT NIP_pengaju,jenis_cuti,alasan_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,no_tlp,sp_dinas,sp_alasan1,sp_bkd,sp_alasan2 FROM cuti_lahir  WHERE  id_pengajuan='$id_pengajuan'  ");
...
echo "<tr>";
echo "<td style='width:400px;'>Selama <b>".$data['lama_cuti']."</b>. Mulai tanggal <b>".$data['tgl_mulai']."</b> (s/d) <b>&nbsp;".$data['tgl_selesai'].".</b></td>";
echo "</tr>";
echo "</table>";
