...
?>
  ...
  <?php
      ...
      $tambah=mysqli_query($con, "INSERT INTO cuti_tahunan (jenis_cuti,tgl_pengajuan,NIP_pengaju,alasan_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,no_tlp) VALUES ('$x','$b','$c','$d','$e','$f','$g','$hi','$i')");

      if($tambah){ 
              header("location:my_cuti_tahunan.php");
              exit();
      }else
              echo "gagal";
      }
...
<td style="width:85%;">
  <input required type="hidden" name="jenis_cuti" value="Tahunan" class="form-control" >
