  ...
  <?php
      ...
      if($mk<5){
        ?> 
          ...
          <h3>&nbsp;&nbsp;&nbsp;<a href="my_cuti_besar.php" class="btn btn-primary" style="width:100px;">Kembali</a></h3><br>
         </table>    
            </div>
              </div>
      ...
      $i=$_POST['no_tlp'];
       ...
       $tambah=mysqli_query($con, "INSERT INTO cuti_besar (jenis_cuti,tgl_pengajuan,NIP_pengaju,alasan_cuti,lama_cuti,tgl_mulai,tgl_selesai,alamat,no_tlp) VALUES ('$x','$b','$c','$d','$e','$f','$g','$hi','$i')");

      if($tambah){ 
              header("location:my_cuti_besar.php");
              exit();
      }else
              echo "gagal";
      }
...
<td style="width:85%;">
  <input required type="hidden" name="jenis_cuti" value="Besar" class="form-control" >
  <!-- <input required type="hidden" name="id_pengajuan" class="form-control" > -->
   <div class="form-group">
    ...
    <div class="form-group"> 
      ...
      <input required type="hidden" value="3" name="lama_cuti" class="form-control" >
     </div>
    <div class="form-group">
