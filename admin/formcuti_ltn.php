...
?>
  ...
  <?php
      ...
      $i=$_POST['no_tlp'];
       ...
       $tambah=mysqli_query($con, "INSERT INTO cuti_ltn (jenis_cuti,tgl_pengajuan,NIP_pengaju,alasan_cuti,gaji_pokok,lama_cuti,tgl_mulai,tgl_selesai,alamat,no_tlp) VALUES ('$x','$b','$c','$d','$v','$e','$f','$g','$hi','$i')");
