...
<?php
    ...
    $query2=mysqli_query($con,"SELECT cuti_kap.id_pengajuan,cuti_kap.NIP_pengaju,data_pns.nama,cuti_kap.tgl_pengajuan,cuti_kap.lama_cuti,cuti_kap.alamat,cuti_kap.tgl_mulai,cuti_kap.tgl_selesai,cuti_kap.sp_kabid,cuti_kap.sp_alasan from cuti_kap inner join data_pns on cuti_kap.NIP_pengaju=data_pns.NIP  where cuti_kap.id_pengajuan='$id'");
