    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i>&nbsp;Riwayat Pengajuan Cuti Tahunan</div>
        <div class="card-body">
...
<?php
    ...
    $query=mysqli_query($con,"SELECT anggota_bidang.NIP,anggota_bidang.kode_bidang,cuti_tahunan.id_pengajuan,data_pns.nama,cuti_tahunan.NIP_pengaju,cuti_tahunan.tgl_pengajuan,cuti_tahunan.alasan_cuti,cuti_tahunan.lama_cuti,cuti_tahunan.alamat,cuti_tahunan.tgl_mulai,cuti_tahunan.tgl_selesai,cuti_tahunan.no_tlp,cuti_tahunan.sp_kabid,cuti_tahunan.sp_alasan FROM cuti_tahunan inner join data_pns on cuti_tahunan.NIP_pengaju=data_pns.NIP inner join anggota_bidang on cuti_tahunan.NIP_pengaju=anggota_bidang.NIP where cuti_tahunan.id_pengajuan='$id'");
...
<h3>Status Pengajuan Cuti Tahunan</h3>
<form>
<td>
